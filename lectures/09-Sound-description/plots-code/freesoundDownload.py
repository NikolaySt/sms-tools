...
Key = "pRkC3lPsoFVML1RhngXC3TzOHn4eDENtI5pZnxmv"

descriptors = [
    'lowlevel.spectral_centroid.mean', 'lowlevel.spectral_centroid.var',
    'lowlevel.mfcc.mean', 'lowlevel.mfcc.var', 'lowlevel.pitch_salience.mean',
    'lowlevel.pitch_salience.var', 'sfx.logattacktime.mean'
]
stats = ['mean', 'var']
...
def downloadSoundsFreesound(queryText="",
  ...
  """
    ...
    if API_Key == "":
        print("\n")
        print(
            "You need a valid freesound API key to be able to download sounds."
        )
...
downloadSoundsFreesound(queryText='trumpet',
                        API_Key=Key,
                        tag='single-note',
                        duration=(0.5, 4),
                        topNResults=20,
                        outputDir='freesound-sounds')
downloadSoundsFreesound(queryText='violin',
                        ...
                        topNResults=20,
                        outputDir='freesound-sounds')
downloadSoundsFreesound(queryText='flute',
                        API_Key=Key,
                        tag='single-note',
                        duration=(0.5, 4),
                        topNResults=20,
