...
descriptors = [
    'lowlevel.spectral_centroid.mean', 'lowlevel.spectral_contrast.mean',
    'lowlevel.dissonance.mean', 'lowlevel.hfc.mean', 'lowlevel.mfcc.mean',
    'sfx.logattacktime.mean', 'sfx.inharmonicity.mean'
]
...
def downloadSoundsFreesound(queryText="",
  ...
  """
    ...
    while (1):
        ...
        print("Downloading mp3 preview and descriptors for sound with id: %s" %
              str(sound.id))
